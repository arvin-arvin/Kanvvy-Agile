...
def start():
    ...
    full_row_button = tk.Button(root, text="Random  ランダム", font=("arial", 20), borderwidth=7, relief="raised", cursor="hand2")
...
def start_general():
    ...
    imgg = tk.PhotoImage(file=generalData[value]['img'])
    img = tk.Label(root, image=imgg)

    giff = tk.PhotoImage(file=generalData[value]['gif'], format="gif -index 2")
    gif = tk.Label(root, image=giff)
    ...
    backBtn = tk.Button(root, text="BACK", command=lastPage, bg="lightblue", font=("arial", 35), borderwidth=7, relief="raised", cursor="hand2")

    nextBtn = tk.Button(root, text="NEXT", command=nextPage, bg="lightblue", font=("arial", 35), borderwidth=7, relief="raised", cursor="hand2")

    name.grid(row=0, column=1, padx=10, pady=5, columnspan=2, sticky="nsew")
    img.grid(row=1, column=1, padx=10, pady=5, columnspan=2, sticky="nsew")
    gif.grid(row=2, column=1, padx=10, pady=5, columnspan=2, sticky="nsew")
